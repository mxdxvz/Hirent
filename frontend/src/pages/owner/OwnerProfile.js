...
export default function Profile() {
  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        const res = await fetch("https://hirent-yw32.onrender.com/api/users/me", {
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        ...
        const res = await fetch("https://hirent-yw32.onrender.com/api/owners/stats", {
          headers: { Authorization: `Bearer ${token}` },
          credentials: "include",
        });
  ...
  const handleSendVerificationEmail = async () => {
    try {
      ...
      const response = await fetch("https://hirent-yw32.onrender.com/api/send-verification-email", {
        method: "POST",
        headers: {
  ...
  const handleSendPhoneVerification = async () => {
    try {
      ...
      const response = await fetch("https://hirent-yw32.onrender.com/api/users/send-phone-verification", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleUploadIdDocument = async () => {
    try {
      ...
      const response = await fetch("https://hirent-yw32.onrender.com/api/users/upload-id-document", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch("https://hirent-yw32.onrender.com/api/api/auth/profile", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
